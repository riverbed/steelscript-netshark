...
class SharkLiveViewTests(SetUpTearDownMixin, testscenarios.TestWithScenarios):
    ...
    #     netshark = self.netshark
    #     job = setup_capture_job(self.netshark)
    #     clip = create_trace_clip(self.netshark, job)
    #     interface = netshark.get_interfaces()[0]
    #     columns, filters = setup_defaults()
    #     with netshark.create_view(
